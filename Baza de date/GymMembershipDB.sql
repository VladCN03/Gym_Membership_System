...
--
-- Host: 127.0.0.1    Database: gymmembershipdb
-- ------------------------------------------------------
...
CREATE TABLE `member` (
  ...
  CONSTRAINT `member_ibfk_1` FOREIGN KEY (`membershipTypeId`) REFERENCES `membershiptype` (`id`),
  CONSTRAINT `member_ibfk_2` FOREIGN KEY (`trainerId`) REFERENCES `trainer` (`id`)
...
-- Dump completed on 2025-10-12 14:49:45
